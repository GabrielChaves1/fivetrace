...
const buttonVariants = cva(
  "inline-flex gap-2 items-center justify-center whitespace-nowrap rounded-md text-sm font-medium border transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        default:
          "bg-primary/45 border-primary/50 shadow hover:bg-primary/60 hover:border-primary",
        destructive:
          "border-destructive/50 shadow-sm hover:bg-destructive/10 hover:border-destructive",
        warn: "border-warn/50 shadow-sm hover:bg-warn/10 hover:border-warn",
        outline:
          "border bg-background shadow-sm hover:bg-foreground/[3%]",
        secondary:
