...
export default function ServerSettingsGeneral() {
  return (
    <>
      <Card>
        <CardContent className="p-6 grid grid-cols-1 gap-6 md:grid-cols-2">
          <h3 className="font-medium text-sm">Configurações gerais</h3>
          <div className="flex flex-col gap-4">
            <div className="flex space-x-3">
              ...
              <div className="flex flex-col gap-1">
                <Label className="text-xs text-muted-foreground">Logo do servidor</Label>
            ...
            <div className="space-y-1">
              ...
              <Input className="h-10 text-xs" placeholder="Nome do servidor" />
            </div>
            <div className="space-y-1">
              <Label className="text-xs text-muted-foreground">IP do servidor</Label>
              <Input className="h-10 text-xs" placeholder="IP do servidor" />
            </div>
          </div>
        </CardContent>
